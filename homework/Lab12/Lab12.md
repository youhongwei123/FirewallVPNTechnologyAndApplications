...
| 访问目标 | 经过的链 | 原因 |
| :--- | :--- | :--- |
| `client -> server:8080` | `FORWARD` | |
| `client -> server:2222` | `FORWARD` | |
| `client -> vpn:9090` | `INPUT` | |
...
| 外层 UDP 目的地址 | |
| 外层 UDP 目标端口 | |
| WireGuard 隧道状态应看 `conntrack` 还是 `wg show` | |
